<html xmlns:tei="http://www.tei-c.org/ns/1.0">
   <head>
      ...
      <title>La brèche des Normands</title>
   ...
   <body>
      ...
      <div id="texte-legende">
         ...
         <p>Un jour, vers le milieu du IXe siècle, on vit 
            ...
            les terres. Très vite ils commencèrent à remonter la Loire, pillant sur leur passage villes et villages, ainsi
            que les monastères ou tout autre institution possédant un peu de richesses.
            Nantes tomba bien vite sous leurs
         ...
         <p>Il est encore possible de voir le tunnel creusé dans la muraille, qui s’appelle aujourd’hui
            la brèche des normands.
         </p>
      </div>
      <div id="autour-legende">
         <div id="contexte-leg">
            <h2>Contexte</h2>
            <p>Au IVᵉ siècle, alors que la ville de Tours prospérait, elle s’entoura d’une muraille
               afin de se protéger
               d'éventuelles attaques des peuples
               germaniques. Ces remparts, symboles de richesse, contenaient l’actuel quartier
               de la Cathédrale
               Saint-Gatien, ainsi que l’amphithéâtre transformé en place forte. On peut aujourd’hui
               encore voir les traces de ces fortifications de part et d’autres de ce
               quartier.
            </p>
         </div>
         <div id="perso-legende">
            <h2>Personnages</h2>
            <ul id="perso-normands">
               <a href="cible_requete.php?personnage_id=perso-normands">Les Normands</a>
               <li>Nom autrefois donné aux Vikings.</li>
               <br></br>
            </ul>
            <ul id="perso-tourangeaux">
